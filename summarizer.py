...
class TranscriptSummarizer:
    ...
    def _initialize_llm(self):
        ...
        # Only try OpenAI if the model doesn't look like an Ollama model
        if self.verbose:
    ...
    def summarize(self):
        ...
        summaries = []
        for chunk in chunks:
            # Handle both Ollama and ChatOpenAI response formats
    ...
    def _create_thread_paragraphs(self, summary, title=None, channel=None, video_id=None, verbose=True):
        ...
        paragraphs.append(f"Summary generated by {self.model}")
